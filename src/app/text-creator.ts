...
export class TextCreator {
  public static makeTextSprite(message, parameters): THREE.Sprite {
    ...
    // let spriteAlignment = parameters.hasOwnProperty("alignment") ?
  ...
  public static roundRect(ctx, x, y, w, h, r) {
    ctx.beginPath();
    ctx.moveTo(x + r, y);
    ctx.lineTo(x + w - r, y);
